...
jQuery(document).ready(function($) {
	...
	var siteMenuClone = function() {
		...
		$('#scroll_to_about').click(function(){
			$('html,body').animate({scrollTop:$('#about-section').offset().top}, 800);
			}); 
		$('#scroll_to_portfolio').click(function(){
			$('html,body').animate({scrollTop:$('#portfolio-section').offset().top}, 800);
			});
		$('#scroll_to_about1').click(function(){
			$('html,body').animate({scrollTop:$('#about-section').offset().top}, 800);
		}); 	
		setTimeout(function() {
